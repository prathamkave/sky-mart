				...
				<div className='flex flex-col justify-between border-r bg-[#111111] border-white px-14 py-12'>
					<div>
						...
						<div className='flex items-center gap-3'>
							...
							<h2 className='text-2xl font-dm-medium font-extrabold'>
						...
						<div className='mt-28 max-w-xl'>
							<p className='text-sm font-semibold uppercase text-lime-400'>
								Welcome Back
							</p>

							<h1 className='mt-4 text-5xl font-dm-medium font-semibold tracking-wider leading-[1.05]'>
								Shop the future.
								<br />
								<span className='text-lime-400'>Today.</span>
							</h1>

							<p className='mt-8 max-w-lg text-xl leading-9 text-zinc-500'>
						...
						<div className='grid grid-cols-3 gap-6 mt-8'>
							{[
								...
								<div
									key={item.label}
									className='rounded-2xl border border-white py-3 transition hover:border-lime-400/40'
								>
									<h3 className='text-center text-2xl font-bold text-lime-400'>
										{item.value}
									</h3>
				...
				<div className='flex items-center justify-center px-16 py-12'>
					<div className='w-full max-w-md rounded-4xl border border-white/10 bg-[#111111] p-8 shadow-2xl'>
						...
						>
							...
							<div>
								<div className='flex items-center rounded-2xl border border-white/10 bg-[#1A1A1A] px-5 py-3 transition focus-within:border-lime-400'>
									<Mail
							...
							<button className='group flex w-full items-center justify-center gap-3 rounded-2xl bg-lime-400 text-md font-semibold text-black transition duration-300 hover:bg-lime-300 px-5 py-3 cursor-pointer'>
								Sign in
								<ArrowRight size={18} />
							</button>
						</form>
